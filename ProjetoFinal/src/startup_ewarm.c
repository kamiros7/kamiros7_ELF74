...
//
//*****************************************************************************
extern void GpioPortCHandler(void);
extern void GpioPortLHandler(void);
extern void GpioPortJHandler(void);

extern void Adc1SS3IntHandler(void);
extern void Adc0SS2IntHandler(void);
...
__root const intvec_elem __vector_table[] =
{
    ...
    GpioPortCHandler,                      // 18-GPIO Port C                ;   2 GPIO Port C
    ...
    Adc0SS2IntHandler,                      // 32-ADC Sequence 2             ;  16 ADC Sequence 2
    IntDefaultHandler,                      // 33-ADC Sequence 3             ;  17 ADC Sequence 3
    IntDefaultHandler,                      // 34-Watchdog timer             ;  18 Watchdog timer 0
    Timer0IntHandler,                      // 35-Timer 0 subtimer A         ;  19 Timer 0 subtimer A
    ...
    Adc1SS3IntHandler,                      // 65-ADC1 Sequence 3            ;  49 ADC1 Sequence 3
    IntDefaultHandler,                      // 66-External Bus Interface 0   ;  50 External Bus Interface 0
    GpioPortJHandler,                      // 67-GPIO Port J                ;  51 GPIO Port J
    IntDefaultHandler,                      // 68-GPIO Port K                ;  52 GPIO Port K
    GpioPortLHandler,                      // 69-GPIO Port L                ;  53 GPIO Port L
